...
Correct the independently verified invalid HCL separator in the acceptance fixture under its own bounded work unit, then rerun the already verified Terraform 1.10.5/1.11.4 matrix. PHE-003 remains active; Phase F and remote operations remain outside scope.
