...
Obtain specific remote authorization to download verified official Terraform 1.10 and 1.11 binaries, then execute the pinned acceptance matrix. PHE-003 remains active until that real runtime evidence passes; Phase F and all other remote operations remain outside the authorized scope.
